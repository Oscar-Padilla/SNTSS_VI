/* Datos mock — SNTSS Sección VI Yucatán. window.DATA */
window.DATA = {
  org: {
    name: "SNTSS",
  ...
  delegados: [
    { nombre: "Lic. Manuel Couoh", role: "Secretario General", unit: "Sección VI", img: "assets/delegado-4.jpg" },
    { nombre: "Romy Casanova", role: "Sría. de Igualdad Sustantiva", unit: "Comité Ejecutivo", img: "assets/delegada-1.jpg" },
    { nombre: "C. Felipe Tamayo", role: "Secretario del Interior", unit: "Comité Ejecutivo", img: "assets/delegado-1.jpg" },
    { nombre: "C. Diego Sansores", role: "Sría. de Previsión Social", unit: "Comité Ejecutivo", img: "assets/delegado-3.jpg" },
  ],
  ...
  eventos: [
    { id: "madres-2026", titulo: "Festejo Día de las Madres 2026", secretaria: "Igualdad Sustantiva", tag: "Inscripciones abiertas", tagType: "rose",
      fecha: "10 de mayo, 2026", hora: "11:00 h", lugar: "Salón Los Pinos, Mérida", img: "assets/news-5.jpg",
    ...
    { id: "ninos-2026", titulo: "Día del Niño · Entrega de juguetes", secretaria: "Igualdad Sustantiva", tag: "Próximamente", tagType: "gold",
      fecha: "30 de abril, 2026", hora: "10:00 h", lugar: "Unidad Deportiva SNTSS", img: "assets/news-2.jpg",
    ...
    { id: "becas-2026", titulo: "Convocatoria de Becas 2026", secretaria: "Acción Educativa", tag: "Abierta", tagType: "purple",
      fecha: "Cierre 15 de junio, 2026", hora: "—", lugar: "En línea", img: "assets/news-3.jpg",
  ...
  noticias: [
    { id: "n1", titulo: "Firma del nuevo Contrato Colectivo beneficia a más de 11 mil agremiados", cat: "Contractual",
      fecha: "24 may 2026", img: "assets/news-1.jpg", autor: "Comité Ejecutivo",
    ...
    { id: "n2", titulo: "Arrancan los cursos de verano para hijos de trabajadores", cat: "Igualdad Sustantiva",
      fecha: "18 may 2026", img: "assets/news-4.jpg", autor: "Romy Casanova",
    ...
    { id: "n3", titulo: "Resultados de la jornada de salud preventiva en Mérida", cat: "Previsión Social",
      fecha: "12 may 2026", img: "assets/news-6.jpg", autor: "Previsión Social",
    ...
    { id: "n4", titulo: "Convocatoria abierta: becas académicas ciclo 2026-2027", cat: "Acción Educativa",
      fecha: "5 may 2026", img: "assets/news-3.jpg", autor: "Acción Educativa",
      extracto: "Apoyos económicos para nivel básico, medio superior y superior. Consulta requisitos y fechas." },
  ],

  // Inscritos de ejemplo para el panel admin del evento Día de las Madres
  inscritos: [
